	...
	LOD 100
		...
		Pass
		{
			...
			fixed4 frag (v2f i ) : SV_Target
			{
				...
				finalColor = tex2D( _refTex, ase_screenPosNorm.xy );
				return finalColor;
			}
			ENDCG
		}

...
Shader "InfiniGRASS/InfiniGrass Directional WindSNOW TRANSPARENT" {
    Properties {
        ...
        _OceanCenter("Ocean Center", Vector) = (0, 0, 0, 0)
         ...
         _RippleScale ("Vary Height", Float ) = 0     
           ...
           _ColorGlobal1 ("Global tint", Color) = (1,1,1,1) //0.5,0.8,0.5
           ...
           //2D extras
           _UVsPosY("UVs positioning definition", Vector) = (0.2, 0.3, 0.4, 0.46) //4 last UVs Y position, to regulate per model //_UVsWindModifier
           _UVsWindModifier("Per UV Wind Modifier", Vector) = (1, 1, 1, 1) //4 last UVs Y position, to regulate wind per UV individually
           _lockToXAxis ("Lock to X axis", Float) = 1
		   scaleGrassY("scale Grass Y", Float) = 0
    }
    SubShader {
 		  	// Cull Back
  		 	 //Zwrite off
        ...
        Pass {
           ...
           // Cull Off
            ...
            float3 _Color;
           	...
           	float3 _ColorGlobal1;

           	//ORTHO
           	float4 _UVsPosY;
           	float4 _UVsWindModifier;
           	float _lockToXAxis;
           ...
           //     v.vertex.xyz += (normalize((float3(1,0.5,0.5)+v.normal))*node_389.r*sin(((node_389.b*3.141592654)+node_392.g+node_392.b))*0.16);
				...
				if (o.uv0.y > 0.01) {
					v.vertex.y = v.vertex.y + scaleGrassY;
				}
...
//				}
//				if( o.uv0.y > _UVsPosY.x){					
//					o.posWorld.x += _BulgeScale*_UVsWindModifier.x*cos(o.posWorld.x*_WaveControl1.x+_Time.y*_TimeControl1.x + o.posWorld.z*_WaveControl1.z)*0.1*sin(o.posWorld.z+_Time.y) + _WaveXFactor*((2+cos(o.posWorld.x/dist))*_OceanCenter.x/3) + _WaveYFactor*((3+sin(2*o.posWorld.z/dist))*_OceanCenter.z/3);
//					o.posWorld.z += _BulgeScale*_UVsWindModifier.x*sin(o.posWorld.x*_WaveControl1.x+_Time.y*_TimeControl1.x + o.posWorld.z*_WaveControl1.z)*0.1*cos(o.posWorld.z+_Time.y) + _WaveXFactor*((2+sin(o.posWorld.z/dist))*_OceanCenter.z/3) + _WaveYFactor*((3+cos(3*o.posWorld.x/dist))*_OceanCenter.x/3);	
//				}
//				if( o.uv0.y > _UVsPosY.y){
//					
//					o.posWorld.x += _BulgeScale*_UVsWindModifier.y*cos(o.posWorld.x*_WaveControl1.x+_Time.y*_TimeControl1.x + o.posWorld.z*_WaveControl1.z)*0.1*sin(o.posWorld.z+_Time.y) + _WaveXFactor*((2+cos(o.posWorld.x/dist))*_OceanCenter.x/3) + _WaveYFactor*((3+sin(2*o.posWorld.z/dist))*_OceanCenter.z/4);
//					o.posWorld.z += _BulgeScale*_UVsWindModifier.y*sin(o.posWorld.x*_WaveControl1.x+_Time.y*_TimeControl1.x + o.posWorld.z*_WaveControl1.z)*0.1*cos(o.posWorld.z+_Time.y) + _WaveXFactor*((2+sin(o.posWorld.z/dist))*_OceanCenter.z/3) + _WaveYFactor*((3+cos(3*o.posWorld.x/dist))*_OceanCenter.x/3);
//				}
//				if( o.uv0.y > _UVsPosY.z){
//					
//					o.posWorld.x += _BulgeScale*_UVsWindModifier.z*cos(o.posWorld.x*_WaveControl1.x+_Time.y*_TimeControl1.x + o.posWorld.z*_WaveControl1.z)*0.1*sin(o.posWorld.z+_Time.y) + _WaveXFactor*((2+cos(o.posWorld.x/dist))*_OceanCenter.x/2) + _WaveYFactor*((3+sin(2*o.posWorld.z/dist))*_OceanCenter.z/2);
//					o.posWorld.z += _BulgeScale*_UVsWindModifier.z*sin(o.posWorld.x*_WaveControl1.x+_Time.y*_TimeControl1.x + o.posWorld.z*_WaveControl1.z)*0.1*cos(o.posWorld.z+_Time.y) + _WaveXFactor*((2+sin(o.posWorld.z/dist))*_OceanCenter.z/2) + _WaveYFactor*((3+cos(3*o.posWorld.x/dist))*_OceanCenter.x/2);	
//				}		
//				if( o.uv0.y > _UVsPosY.w){//0.96
//					
//					o.posWorld.x += _BulgeScale*_UVsWindModifier.w*cos(o.posWorld.x*_WaveControl1.x+_Time.y*_TimeControl1.x + o.posWorld.z*_WaveControl1.z)*0.1*sin(o.posWorld.z+_Time.y) + _WaveXFactor*((2+cos(o.posWorld.x/dist))*_OceanCenter.x/0.9)	+ _WaveYFactor*((3+sin(2*o.posWorld.z/dist))*_OceanCenter.z/1);
//					o.posWorld.z += _BulgeScale*_UVsWindModifier.w*sin(o.posWorld.x*_WaveControl1.x+_Time.y*_TimeControl1.x + o.posWorld.z*_WaveControl1.z)*0.1*cos(o.posWorld.z+_Time.y) + _WaveXFactor*((2+sin(o.posWorld.z/dist))*_OceanCenter.z/0.9) + _WaveYFactor*((3+cos(3*o.posWorld.x/dist))*_OceanCenter.x/1);
//
//					//o.posWorld.x += _BulgeScale*_UVsWindModifier.w*cos(o.posWorld.x*_WaveControl1.x+_Time.y*_TimeControl1.x + 0);   //_lockToXAxis
//				}	


				if( o.uv0.y > _UVsPosY.x){//0.96					
					o.posWorld.x += _BulgeScale*_UVsWindModifier.x*o.uv0.y*cos(o.posWorld.x*_WaveControl1.x+_Time.y*_TimeControl1.x + _lockToXAxis*o.posWorld.z*_WaveControl1.z)*0.1*sin((1-_lockToXAxis)*o.posWorld.z+_Time.y) + _WaveXFactor*((2+cos(o.posWorld.x/dist))*_OceanCenter.x/0.9)	+ _WaveYFactor*((3+sin(2*o.posWorld.z/dist))*_OceanCenter.z/1);
					o.posWorld.z += _lockToXAxis*(_BulgeScale*_UVsWindModifier.x*sin(o.posWorld.x*_WaveControl1.x+_Time.y*_TimeControl1.x + _lockToXAxis*o.posWorld.z*_WaveControl1.z)*0.1*cos(o.posWorld.z+_Time.y) + _WaveXFactor*((2+sin(o.posWorld.z/dist))*_OceanCenter.z/0.9) + _WaveYFactor*((3+cos(3*o.posWorld.x/dist))*_OceanCenter.x/1));
				}	
				if( o.uv0.y > _UVsPosY.w){
					o.posWorld.x += _BulgeScale*_UVsWindModifier.w*cos((_UVsWindModifier.w)*o.posWorld.x*_WaveControl1.x+_UVsWindModifier.w*_Time.y*_TimeControl1.x + 0)*o.uv0.y;
				}
...
//                #endif
             ...
             //   finalColor += diffuseLight * (lerp(float3(node_331,node_331,node_331),float3(0.9632353,0.8224623,0.03541304),i.vertexColor.b)*node_1.rgb);
                finalColor += diffuseLight * (node_1.rgb)*_ColorGlobal1;
...
//				
//
//                return fixed4(finalColor * 1,0.5);
//            }
//            ENDCG
//        }
//        Pass {

...
public class InfiniGRASSPlanterHERO : MonoBehaviour {      
        ...
        //v1.9.9.3
        public bool overrideSpread = false; //overide density of Grass manager for the selected brush
        public Vector2 minMaxSpread = new Vector2(8, 10);
            ...
            if (enablePlanting && (transform.position - prevPos).magnitude > plantDistance)
            {
                ...
                {                    
                    ...
                    if (Physics.Raycast(ray1, out hit, 1000))
                    {
                        ...
                        if (overrideSpread)
                        {
                            Grassmanager.Min_spread = minMaxSpread.x;
                            Grassmanager.Max_spread = minMaxSpread.y;
                        }

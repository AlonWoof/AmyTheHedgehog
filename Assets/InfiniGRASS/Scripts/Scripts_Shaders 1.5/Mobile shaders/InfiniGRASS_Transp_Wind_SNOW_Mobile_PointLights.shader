...
Shader "InfiniGRASS/InfiniGrass Directional Wind SNOW Mobile Point Lights" {
    Properties {
...
//                #else
               ...
               // #endif
                ...
                lightDirection =  (reflect(_WorldSpaceLightPos0.xyz,normalDirection));
...
//				}
                ...
                //END SNOW
                float4 col =fixed4(finalColor * _Color  + specular* _SpecularPower * _LightColor0.xyz,1);//v1.7.7

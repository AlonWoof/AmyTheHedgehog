...
Shader "AlonWoof/Dolphin/Water_UV"
{
	Properties
	{
		...
		_EdgeFresnel("EdgeFresnel", Color) = (0,0,0,0)
	...
	SubShader
	{
		...
		uniform float4 _EdgeFresnel;
		uniform float _SpecularPower;
		uniform float _SpecularGloss;

		void surf( Input i , inout SurfaceOutput o )
		{
			float2 panner35 = ( 1.0 * _Time.y * _FlowDirection1 + ( i.uv_texcoord * _Scale ));
			...
			float fresnelNdotV129 = dot( ase_normWorldNormal, ase_worldViewDir );
			float fresnelNode129 = ( 0.0 + 1.0 * pow( max( 1.0 - fresnelNdotV129 , 0.0001 ), 40.0 ) );
			float4 lerpResult131 = lerp( float4( 0,0,0,0 ) , _EdgeFresnel , fresnelNode129);
			o.Emission = ( ( clampResult126 + lerpResult131 ) * i.vertexColor ).rgb;
...
/*ASEBEGIN
Version=19105
Node;AmplifyShaderEditor.RangedFloatNode;82;-2460.732,-1308.642;Inherit;False;Property;_DepthDistance;DepthDistance;5;0;Create;True;0;0;0;False;0;False;16;8;0;0;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.RangedFloatNode;91;-2284.034,-1157.336;Inherit;False;Property;_DepthPower;DepthPower;7;0;Create;True;0;0;0;False;0;False;1;0.884;0;1;0;1;FLOAT;0
Node;AmplifyShaderEditor.Vector2Node;121;-3688.42,554.532;Inherit;False;Property;_FlowDirection2;FlowDirection2;12;0;Create;True;0;0;0;False;0;False;0.03,0.01;0,0.05;0;3;FLOAT2;0;FLOAT;1;FLOAT;2
...
Node;AmplifyShaderEditor.Vector2Node;122;-3677.42,686.532;Inherit;False;Property;_FlowDirection3;FlowDirection3;14;0;Create;True;0;0;0;False;0;False;0.03,0.01;0,0.2;0;3;FLOAT2;0;FLOAT;1;FLOAT;2
...
Node;AmplifyShaderEditor.RangedFloatNode;33;-1396.188,-257.7399;Inherit;False;Property;_DistortAmount;DistortAmount;4;0;Create;True;0;0;0;False;0;False;1;0.2;0;1;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.ColorNode;105;129.1584,526.2966;Inherit;False;Property;_EdgeColor;EdgeColor;10;1;[HDR];Create;True;0;0;0;False;0;False;0,0,0,0;0,0,0,0;True;0;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
...
Node;AmplifyShaderEditor.RangedFloatNode;51;587.3096,-568.7322;Inherit;False;Property;_SpecularGloss;SpecularLevel;17;0;Create;False;0;0;0;False;0;False;0.5;0.5;0;3;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.RangedFloatNode;62;587.1202,-638.7905;Inherit;False;Property;_SpecularPower;SpecularPower;18;0;Create;True;0;0;0;False;0;False;2;2;0.05;5;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.Vector2Node;120;-3688.627,410.3351;Inherit;False;Property;_FlowDirection1;FlowDirection1;13;0;Create;True;0;0;0;False;0;False;0.03,0.01;0,0.1;0;3;FLOAT2;0;FLOAT;1;FLOAT;2
...
Node;AmplifyShaderEditor.RangedFloatNode;103;-544.9875,75.037;Inherit;False;Property;_EdgeDistance;Edge Distance;9;0;Create;True;0;0;0;False;0;False;0;2.41;0;0;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.RangedFloatNode;102;-110.4421,263.5504;Inherit;False;Property;_EdgePower;Edge Power;8;0;Create;True;0;0;0;False;0;False;0;9.4;0;0;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.SamplerNode;106;100.379,845.8342;Inherit;True;Property;_EdgeFoamTex;EdgeFoamTex;11;0;Create;True;0;0;0;False;0;False;-1;None;76dd2447f18d60e4daf8283b38908589;True;0;False;white;Auto;False;Object;-1;Auto;Texture2D;8;0;SAMPLER2D;;False;1;FLOAT2;0,0;False;2;FLOAT;0;False;3;FLOAT2;0,0;False;4;FLOAT2;0,0;False;5;FLOAT;1;False;6;FLOAT;0;False;7;SAMPLERSTATE;;False;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
...
Node;AmplifyShaderEditor.SamplerNode;26;-2836.636,-205.5245;Inherit;True;Property;_NormalMap;NormalMap;0;1;[Normal];Create;True;0;0;0;False;0;False;-1;None;db994ea24e3a86a42b48aa5148d55f3b;True;0;True;bump;Auto;True;Object;-1;Auto;Texture2D;8;0;SAMPLER2D;;False;1;FLOAT2;0,0;False;2;FLOAT;0;False;3;FLOAT2;0,0;False;4;FLOAT2;0,0;False;5;FLOAT;1;False;6;FLOAT;0;False;7;SAMPLERSTATE;;False;5;FLOAT3;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
Node;AmplifyShaderEditor.GetLocalVarNode;116;910.856,-304.8565;Inherit;False;74;edgeStrength;1;0;OBJECT;;False;1;FLOAT;0
Node;AmplifyShaderEditor.ColorNode;85;-1001.413,-696.278;Inherit;False;Property;_DepthColor;DepthColor;6;0;Create;True;0;0;0;False;0;False;0.1376825,0.2308503,0.3207547,1;0.6021716,0.6235263,0.6415094,0;True;0;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
Node;AmplifyShaderEditor.SamplerNode;123;-1049.636,-892.38;Inherit;True;Property;_TextureSample0;Texture Sample 0;15;0;Create;True;0;0;0;False;0;False;-1;None;db994ea24e3a86a42b48aa5148d55f3b;True;0;True;bump;Auto;True;Object;-1;Auto;Texture2D;8;0;SAMPLER2D;;False;1;FLOAT2;0,0;False;2;FLOAT;0;False;3;FLOAT2;0,0;False;4;FLOAT2;0,0;False;5;FLOAT;1;False;6;FLOAT;0;False;7;SAMPLERSTATE;;False;5;FLOAT3;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
Node;AmplifyShaderEditor.SamplerNode;63;-3022.832,131.1331;Inherit;True;Property;_NormalMap2;NormalMap2;1;1;[Normal];Create;True;0;0;0;False;0;False;-1;None;None;True;0;True;bump;Auto;True;Object;-1;Auto;Texture2D;8;0;SAMPLER2D;;False;1;FLOAT2;0,0;False;2;FLOAT;0;False;3;FLOAT2;0,0;False;4;FLOAT2;0,0;False;5;FLOAT;0.5;False;6;FLOAT;0;False;7;SAMPLERSTATE;;False;5;FLOAT3;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
Node;AmplifyShaderEditor.SamplerNode;98;-3060.971,435.3463;Inherit;True;Property;_NormalMap3;NormalMap3;2;1;[Normal];Create;True;0;0;0;False;0;False;-1;None;None;True;0;True;bump;Auto;True;Object;-1;Auto;Texture2D;8;0;SAMPLER2D;;False;1;FLOAT2;0,0;False;2;FLOAT;0;False;3;FLOAT2;0,0;False;4;FLOAT2;0,0;False;5;FLOAT;0.5;False;6;FLOAT;0;False;7;SAMPLERSTATE;;False;5;FLOAT3;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
Node;AmplifyShaderEditor.WorldPosInputsNode;93;-4269.152,163.3373;Inherit;False;0;4;FLOAT3;0;FLOAT;1;FLOAT;2;FLOAT;3
Node;AmplifyShaderEditor.WorldPosInputsNode;64;-4053.245,-40.05489;Inherit;False;0;4;FLOAT3;0;FLOAT;1;FLOAT;2;FLOAT;3
Node;AmplifyShaderEditor.ClampOpNode;126;996.3528,-113.316;Inherit;False;3;0;COLOR;0,0,0,0;False;1;COLOR;0,0,0,0;False;2;COLOR;1,1,1,1;False;1;COLOR;0
Node;AmplifyShaderEditor.FresnelNode;129;1173.448,138.7175;Inherit;False;Standard;WorldNormal;ViewDir;True;True;5;0;FLOAT3;0,0,1;False;4;FLOAT3;0,0,0;False;1;FLOAT;0;False;2;FLOAT;1;False;3;FLOAT;40;False;1;FLOAT;0
Node;AmplifyShaderEditor.ColorNode;130;1186.804,353.1706;Inherit;False;Property;_EdgeFresnel;EdgeFresnel;19;0;Create;True;0;0;0;False;0;False;0,0,0,0;1,1,1,0.0627451;True;0;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
Node;AmplifyShaderEditor.LerpOp;131;1420.804,225.7706;Inherit;False;3;0;COLOR;0,0,0,0;False;1;COLOR;0,0,0,0;False;2;FLOAT;0;False;1;COLOR;0
Node;AmplifyShaderEditor.WorldPosInputsNode;29;-3632.169,-547.0367;Inherit;False;0;4;FLOAT3;0;FLOAT;1;FLOAT;2;FLOAT;3
Node;AmplifyShaderEditor.TextureCoordinatesNode;133;-3442.984,-566.397;Inherit;False;0;-1;2;3;2;SAMPLER2D;;False;0;FLOAT2;1,1;False;1;FLOAT2;0,0;False;5;FLOAT2;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
Node;AmplifyShaderEditor.ComponentMaskNode;30;-3320.346,-434.9304;Inherit;False;True;False;True;True;1;0;FLOAT3;0,0,0;False;1;FLOAT2;0
Node;AmplifyShaderEditor.StandardSurfaceOutputNode;21;1713.51,-487.4448;Float;False;True;-1;2;ASEMaterialInspector;0;0;BlinnPhong;AlonWoof/Dolphin/Water_UV;False;False;False;False;False;False;False;False;False;False;False;False;False;False;True;False;False;False;False;False;False;Off;0;False;;0;False;;False;0;False;;0;False;;False;0;Transparent;0.5;True;True;0;False;Transparent;;Transparent;All;12;all;True;True;True;True;0;False;;False;0;False;;255;False;;255;False;;0;False;;0;False;;0;False;;0;False;;0;False;;0;False;;0;False;;0;False;;False;2;15;10;25;False;0.5;True;2;5;False;;10;False;;0;0;False;;0;False;;0;False;;0;False;;0;False;0;0,0,0,0;VertexOffset;True;False;Cylindrical;False;True;Relative;0;;-1;-1;-1;-1;0;False;0;0;False;;16;0;False;;0;0;0;False;0.1;False;;0;False;;False;15;0;FLOAT3;0,0,0;False;1;FLOAT3;0,0,0;False;2;FLOAT3;0,0,0;False;3;FLOAT;0;False;4;FLOAT;0;False;6;FLOAT3;0,0,0;False;7;FLOAT3;0,0,0;False;8;FLOAT;0;False;9;FLOAT;0;False;10;FLOAT;0;False;13;FLOAT3;0,0,0;False;11;FLOAT3;0,0,0;False;12;FLOAT3;0,0,0;False;14;FLOAT4;0,0,0,0;False;15;FLOAT3;0,0,0;False;0
Node;AmplifyShaderEditor.SimpleMultiplyOpNode;32;-3036.409,-513.1556;Inherit;False;2;2;0;FLOAT2;0,0;False;1;FLOAT;0;False;1;FLOAT2;0
Node;AmplifyShaderEditor.RangedFloatNode;31;-3897.607,-249.9658;Inherit;False;Property;_Scale;Scale;3;0;Create;True;0;0;0;False;0;False;0;2;0;10;0;1;FLOAT;0
Node;AmplifyShaderEditor.GetLocalVarNode;73;1122.589,-361.407;Inherit;False;71;waterNormalMix;1;0;OBJECT;;False;1;FLOAT3;0
Node;AmplifyShaderEditor.SimpleAddOpNode;132;1418.204,-203.2294;Inherit;False;2;2;0;COLOR;0,0,0,0;False;1;COLOR;0,0,0,0;False;1;COLOR;0
Node;AmplifyShaderEditor.VertexColorNode;134;1678.033,-3.98291;Inherit;False;0;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
Node;AmplifyShaderEditor.SimpleMultiplyOpNode;135;1567.533,-9.182922;Inherit;False;2;2;0;COLOR;0,0,0,0;False;1;COLOR;0,0,0,0;False;1;COLOR;0
...
WireConnection;21;2;135;0
WireConnection;21;3;62;0
WireConnection;21;4;51;0
WireConnection;32;0;133;0
...
ASEEND*/
//CHKSM=0C4CE9BB346754F1C2F4A8186E02C3313F23226A
// Upgrade NOTE: upgraded instancing buffer 'AlonWoofDolphinMultiply' to new syntax.

// Made with Amplify Shader Editor v1.9.1.5
// Available at the Unity Asset Store - http://u3d.as/y3X 
Shader "AlonWoof/Dolphin/Multiply"
{
	Properties
	{
	...
	SubShader
	{
		...
		UNITY_INSTANCING_BUFFER_START(AlonWoofDolphinMultiply)
			UNITY_DEFINE_INSTANCED_PROP(float4, _MainTex_ST)
#define _MainTex_ST_arr AlonWoofDolphinMultiply
			UNITY_DEFINE_INSTANCED_PROP(float4, _Color)
#define _Color_arr AlonWoofDolphinMultiply
		UNITY_INSTANCING_BUFFER_END(AlonWoofDolphinMultiply)
...
ASEEND*/
//CHKSM=18BCB101C4510976F1C83802BCEB56642A89C221
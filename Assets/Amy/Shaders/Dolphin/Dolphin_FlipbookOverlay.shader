// Upgrade NOTE: upgraded instancing buffer 'AlonWoofDolphinFlipbookOverlay' to new syntax.

// Made with Amplify Shader Editor v1.9.1.5
// Available at the Unity Asset Store - http://u3d.as/y3X 
Shader "AlonWoof/Dolphin/FlipbookOverlay"
{
	Properties
	{
	...
	SubShader
	{
		...
		UNITY_INSTANCING_BUFFER_START(AlonWoofDolphinFlipbookOverlay)
			UNITY_DEFINE_INSTANCED_PROP(float4, _Bump_ST)
#define _Bump_ST_arr AlonWoofDolphinFlipbookOverlay
			UNITY_DEFINE_INSTANCED_PROP(float4, _MainTex_ST)
#define _MainTex_ST_arr AlonWoofDolphinFlipbookOverlay
			UNITY_DEFINE_INSTANCED_PROP(float4, _Mask_ST)
#define _Mask_ST_arr AlonWoofDolphinFlipbookOverlay
			UNITY_DEFINE_INSTANCED_PROP(float, _Speed)
#define _Speed_arr AlonWoofDolphinFlipbookOverlay
		UNITY_INSTANCING_BUFFER_END(AlonWoofDolphinFlipbookOverlay)
		...
		void surf( Input i , inout SurfaceOutput o )
		{
			...
			float fbtotaltiles37 = _ColumsRows.x * _ColumsRows.y;
			// Offsets for cols and rows of Flipbook Texture
			float fbcolsoffset37 = 1.0f / _ColumsRows.x;
			float fbrowsoffset37 = 1.0f / _ColumsRows.y;
			// Speed of animation
			float fbspeed37 = _Time[ 1 ] * _Speed_Instance;
			...
			float fblinearindextox37 = round ( fmod ( fbcurrenttileindex37, _ColumsRows.x ) );
			// Multiply Offset X by coloffset
			float fboffsetx37 = fblinearindextox37 * fbcolsoffset37;
			// Obtain Offset Y coordinate from current tile linear index
			float fblinearindextoy37 = round( fmod( ( fbcurrenttileindex37 - fblinearindextox37 ) / _ColumsRows.x, _ColumsRows.y ) );
			// Reverse Y to get tiles from Top to Bottom
			fblinearindextoy37 = (int)(_ColumsRows.y-1) - fblinearindextoy37;
			// Multiply Offset Y by rowoffset
			float fboffsety37 = fblinearindextoy37 * fbrowsoffset37;
			// UV Offset
			float2 fboffset37 = float2(fboffsetx37, fboffsety37);
			// Flipbook UV
			half2 fbuv37 = ase_screenPosNorm.xy * fbtiling37 + fboffset37;
			// *** END Flipbook UV Animation vars ***
			float4 TextureOverlay40 = tex2D( _Overlay, fbuv37 );
			...
			float4 blendOpSrc42 = TextureOverlay40;
			float4 blendOpDest42 = finalColor19;
...
Node;AmplifyShaderEditor.StandardSurfaceOutputNode;0;-121.121,-366.3776;Float;False;True;-1;2;ASEMaterialInspector;0;0;BlinnPhong;AlonWoof/Dolphin/FlipbookOverlay;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;Back;0;False;;0;False;;False;0;False;;0;False;;False;0;Opaque;0.5;True;True;0;False;Opaque;;Geometry;All;12;all;True;True;True;True;0;False;;False;0;False;;255;False;;255;False;;0;False;;0;False;;0;False;;0;False;;0;False;;0;False;;0;False;;0;False;;False;2;15;10;25;False;0.5;True;0;0;False;;0;False;;0;0;False;;0;False;;0;False;;0;False;;0;False;0;0,0,0,0;VertexOffset;True;False;Cylindrical;False;True;Relative;0;;-1;-1;-1;-1;0;False;0;0;False;;4;0;False;;0;0;0;False;0.1;False;;0;False;;False;15;0;FLOAT3;0,0,0;False;1;FLOAT3;0,0,0;False;2;FLOAT3;0,0,0;False;3;FLOAT;0;False;4;FLOAT;0;False;6;FLOAT3;0,0,0;False;7;FLOAT3;0,0,0;False;8;FLOAT;0;False;9;FLOAT;0;False;10;FLOAT;0;False;13;FLOAT3;0,0,0;False;11;FLOAT3;0,0,0;False;12;FLOAT3;0,0,0;False;14;FLOAT4;0,0,0,0;False;15;FLOAT3;0,0,0;False;0
...
Node;AmplifyShaderEditor.TFHCFlipBookUVAnimation;37;216.5046,-1642.274;Inherit;False;0;0;6;0;FLOAT2;0,0;False;1;FLOAT;0;False;2;FLOAT;0;False;3;FLOAT;0;False;4;FLOAT;0;False;5;FLOAT;0;False;3;FLOAT2;0;FLOAT;1;FLOAT;2
Node;AmplifyShaderEditor.CommentaryNode;38;-257.7772,-1406.617;Inherit;False;672.0276;447.0729;Screenspace Overlay;2;41;40;;1,1,1,1;0;0
Node;AmplifyShaderEditor.RegisterLocalVarNode;40;223.783,-1061.87;Inherit;False;TextureOverlay;-1;True;1;0;COLOR;0,0,0,0;False;1;COLOR;0
...
Node;AmplifyShaderEditor.SamplerNode;41;-48.21704,-1321.87;Inherit;True;Property;_Overlay;Overlay;10;0;Create;True;0;0;0;False;0;False;-1;None;None;True;0;False;gray;Auto;False;Object;-1;Auto;Texture2D;8;0;SAMPLER2D;;False;1;FLOAT2;0,0;False;2;FLOAT;0;False;3;FLOAT2;0,0;False;4;FLOAT2;0,0;False;5;FLOAT;1;False;6;FLOAT;0;False;7;SAMPLERSTATE;;False;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
Node;AmplifyShaderEditor.BlendOpsNode;42;-383.8922,-673.6268;Inherit;False;Overlay;True;3;0;COLOR;0,0,0,0;False;1;COLOR;0,0,0,0;False;2;FLOAT;1;False;1;COLOR;0
Node;AmplifyShaderEditor.Vector2Node;34;-338.4954,-1665.274;Inherit;False;Property;_ColumsRows;Colums/Rows;9;0;Create;True;0;0;0;False;0;False;1,1;1,1;0;3;FLOAT2;0;FLOAT;1;FLOAT;2
Node;AmplifyShaderEditor.RangedFloatNode;35;-331.4954,-1533.274;Inherit;False;InstancedProperty;_Speed;Speed;8;0;Create;True;0;0;0;False;0;False;1;0;0;0;0;1;FLOAT;0
Node;AmplifyShaderEditor.ScreenPosInputsNode;39;-662.7014,-1573.653;Float;True;0;False;0;5;FLOAT4;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
Node;AmplifyShaderEditor.UnityObjToClipPosHlpNode;54;-438.2971,45.85303;Inherit;False;1;0;FLOAT3;0,0,0;False;5;FLOAT4;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
Node;AmplifyShaderEditor.PosVertexDataNode;55;-697.2971,76.85303;Inherit;False;0;0;5;FLOAT3;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
Node;AmplifyShaderEditor.ScreenParams;56;-622.8083,-899.245;Inherit;False;0;5;FLOAT4;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
Node;AmplifyShaderEditor.GetLocalVarNode;43;-655.041,-739.9357;Inherit;False;40;TextureOverlay;1;0;OBJECT;;False;1;COLOR;0
Node;AmplifyShaderEditor.GetLocalVarNode;6;-585.1985,-596.4017;Inherit;False;19;finalColor;1;0;OBJECT;;False;1;COLOR;0
...
ASEEND*/
//CHKSM=060CC69BDC75A6F119CC45723F090C96AB863F49
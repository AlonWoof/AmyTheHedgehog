    ...
    public class ActorLookAtController : MonoBehaviour
    {
        ...
        void LateUpdate()
        {
            ...
            else
            {
                ...
                headLook.solver.target.transform.position = Vector3.Lerp(headLook.solver.target.transform.position, desiredLookAt + (z_offset * Vector3.up), Time.deltaTime * 8.0f);
            }
